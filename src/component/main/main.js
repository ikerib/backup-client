...
class Main extends Component {
  ...
  handleSelect(option) {
    ...
    let selectedData = option.target[option.target.selectedIndex].getAttribute(
      "data-dir"
    ); //mnt/nfs/Donibane/Grupos
    ...
    if (this.state.snapshoots && this.state.snapshoots.length > 0) {
      divCombo = (
        <div className="col-md-3">
          ...
          >
            <option key="-1" value="Aukeratu bat" selected={true}>
              Aukeratu bat
            </option>
            {this.state.snapshoots.map((option, index) => {
              return (
                <option key={index} data-dir={option.dir} value={option.fs}>
                  {option.dt}
                </option>
              );
            })}
      ...
      divCombo = <div className="col-md-3" />;
    }
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-sm-12 col-md-12  main">
              {this.state.erroreTextua.length > 0 ? (
                <Errorea erroreTextua={this.state.erroreTextua} />
              ) : null}
